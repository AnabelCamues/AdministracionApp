...
/* Organización */
Vue.component('organization-index', require('./Components/Views/Sistema/organization/Index').default);
Vue.component('organization-modal', require('./Components/Views/Sistema/organization/Modal').default);


/* Productos */
Vue.component('products-index', require('./Components/Views/Sistema/products/Index').default);
Vue.component('products-modal', require('./Components/Views/Sistema/products/Modal').default);

/* Orders */
Vue.component('orders-index', require('./Components/Views/Sistema/orders/Index').default);
// Vue.component('products-modal', require('./Components/Views/Sistema/products/Modal').default);
