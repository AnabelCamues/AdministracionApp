        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-8">
                <div class="back-image"
                     :style="'background-image: url('+'https://lahora.com.ec/contenido/cache/4e/las-actividades-se-retoman-en-yahuarcocha-imagen-1-_20200720095022-1200x800.jpg'+')'">
                </div>
            </div>
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <p class="text-center mt-5">
                                    {{ $t('copyright_text')  }} Yahuarcocha app
                                </p>
                            </div>
                        </div>
                    </form>
